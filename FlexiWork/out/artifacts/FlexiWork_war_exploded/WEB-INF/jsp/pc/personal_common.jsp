...
<body>
	<div class="div_zhong_l">
		...
		<ul class="ul_l_l">
			...
			<li><a href="${ctx}/pc/personal/goMyWork.action" title="发布兼职" target="_parent"><span class="span_1 span_l" align="center">发布兼职</span></a></li>
			<li><a href="${ctx}/pc/personal/goMyjianzhi.action" title="我的兼职" target="_parent"><span class="span_1 span_l" align="center">我的兼职</span></a></li>
